...
export default function HospitalRegister() {
  ...
  const onSubmit = async (data) => {
    ...
    try {
      ...
      router.push('/hospital?success=true');
    } catch (error) {
    ...
    <div className="max-w-md mx-auto py-10">
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Create an account for your hospital to manage doctors and appointments
          </CardDescription>
        </CardHeader>
        <CardContent>
        ...
        <CardFooter className="flex justify-center">
          <p className="text-sm text-gray-500">
            ...
            <Link href="/hospital" className="text-blue-500 hover:underline">
              Login here
            </Link>
          </p>
        </CardFooter>
